...
var Lines = (function () {
  ...
  function addBalls(callback) {
    ...
    if (
      ...
      // console.log(bgColorFromLastClick);
      if (
        ...
        function justAddOneBall28_04() {
          ...
          for (var i = 0; i < 1; i++) {
            ...
            if (emptyCells.length > 0) {
              ...
              cell.className = "ball " + `${bgColorFromLastClick}` + " fadein";
            }
          }
        }
        justAddOneBall28_04();
        ...
        if (cellWithMyColor.length > 0 && a > 0 && a < 1000000000000) {
          ...
          if (
            ...
            setTimeout(() => {
              ...
              // need to make it empty again
              myCurrentClickPosition = "";
              // NEED TO CHANGE THIS FROM TEST FUNC TO PROD FUNC(can find it in test.js file)
              function checkIfLineForProduction() {
                ...
                if (lineSets.length > 0) {
                  ...
                  console.log("lineSets", lineSets);
                  console.log(
                    "10 POINTS TO GRIFFINDOR(ball was added by comp)"
                  );
                  // maybe here I also need to add smht like "refreshIntervalId = setInterval(timer, 250);", but not sure, need to test
                } else {
                  // Checks if the grid is completely filled with balls
